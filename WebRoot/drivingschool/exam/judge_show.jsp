		...
		<table width="100%" border="0" align="center" cellpadding="4" cellspacing="4" bordercolor="#666666">
			<tbody>
				<tr>
	               	...
	               	<td>
	               		<label id="qq">${newJudgeExam.examTitle}</label>
	               	</td>
             	</tr>
             	<tr>
	               	<td width="150" align="right">
             	...
             	<tr>
	               	...
	               	<td>
	               		<label id="qq">${newJudgeExam.examAnswer}</label>
	               	</td>
             	</tr>
             	...
             	<tr>
				    ...
				    <td>
		            	<fmt:formatDate value="${newJudgeExam.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />
				    </td>
				</tr> 
				<tr>
				    <td width="150" align="right">
				    ...
				    <td>
		            	<fmt:formatDate value="${newJudgeExam.updateTime}" pattern="yyyy-MM-dd HH:mm:ss" />
				    </td>
				</tr>
